...
public enum S3ErrorCode implements ErrorCode {
    ...
    S3_DOWNLOAD_SERVICE_ERROR("AWS005", HttpStatus.INTERNAL_SERVER_ERROR, "[DOWNLOAD] S3 서비스 오류입니다."),
    ...
    AW3_DOWNLOAD_SERVICE_ERROR("AWS014", HttpStatus.INTERNAL_SERVER_ERROR, "[DOWNLOAD] AW3 서비스 오류입니다."),
